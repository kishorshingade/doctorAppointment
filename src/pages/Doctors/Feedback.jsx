          ...
          <div className="flex justify-between gap-10 mb-[30px]">
              <div className="flex gap-3">
                 <figure className='w-10 h-10 rounded-full'>
                  <img className='w-full' src={avtar} alt="" />
                 </figure>
                  
                  <div>
                    <h5 className="text-[16px] leading-6 text-primaryColor font-bold">Harish Chaurasiya</h5>
                    <p className="text-[14px] leading-6 text-textColor">{formateDate('02-14-2024')}</p>
