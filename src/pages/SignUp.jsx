                 ...
                 <div className="hidden lg:block  rounded-l-lg">
                   ...
                   <form action="" onSubmit={submitHandler}>
                       ...
                       <div className="mb-5">
                        ...
                        <div className="mb-5">
                          <input type="eamil" placeholder='Enter Your Email' name='eamil' value={formData.eamil}
                          onChange={handleInputChange}
                          className='w-full pr-4 py-3 border-b  border-solid border-[#0066ff61]
                             focus:outline-none focus:border-b-primaryColor text-[16px] leading-7 text-headingColor
                           placeholder:text-textColor cursor-pointer' required/>
                        ...
                        <div className="mb-5 flex items-center justify-between">
                           <label htmlFor="" className='text-headingColor font-bold text-[16px] leading-7' >
                            Are you a :
                            <select name="role" className='text-textColor font-semibold text-[15px] leading-7 px-4
                            py-3 focus:outline-none' onChange={handleInputChange} value={formData.role}>
                           ...
                           <label htmlFor="" className='text-headingColor font-bold text-[16px] leading-7' >
                            ...
                            py-3 focus:outline-none' onChange={handleInputChange} value={formData.gender}>
                        ...
                        <div className="mb-5 flex items-center gap-3">
                           ...
                           border-primaryColor flex items-center justify-center'>
                            ...
                            <div className='relative w-[130px] h-[50px]'>
                              <input className='absolute top-0 left-0 w-full opacity-0 cursor-pointer'
                               onChange={handleFileInputChange}
                               type="file" name='photo' id='customFile' accept='.jpg, .png ' />
                              ...
                              overflow-hidden bg-[#0066ff46] text-headingColor font-semibold rounded-lg
                              cursor-pointer'>Upload Photo</label>
                            </div>
